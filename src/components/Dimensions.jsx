...
import { rowsOptions, colsOptions, minRows, minColumns, maxRows, maxColumns } from '../common/config'
...
export const Dimensions = ({ rows, cols, resetGrid, setRows, setCols }) => {
    ...
    return (
        <Container>
            <SliderContainer>
                ...
                <Label>
                    Columns
                    <Slider min={minColumns} max={maxColumns} value={cols} onChange={setCols} handle={handle} />
                </Label>
            </SliderContainer>
            ...
            <DropdownContainer>
                <Label>
                    Rows
                    <Dropdown options={rowsOptions} value={String(rows)} onChange={(e) => setRows(+e.value)} />
                </Label>

                <Label>
                    Columns
                    <Dropdown options={colsOptions} value={String(cols)} onChange={(e) => setCols(+e.value)} />
                </Label>
